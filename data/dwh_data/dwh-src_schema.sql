...
CREATE SCHEMA IF NOT EXISTS pactravel_source AUTHORIZATION postgres;

CREATE TABLE pactravel_source.aircrafts (
...
CREATE TABLE pactravel_source.airlines (
...
CREATE TABLE pactravel_source.airports (
...
CREATE TABLE pactravel_source.customers (
...
CREATE TABLE pactravel_source.hotel (
...
CREATE TABLE pactravel_source.flight_bookings (
	...
	CONSTRAINT fk_flight_aircraft FOREIGN KEY (aircraft_id) REFERENCES pactravel_source.aircrafts(aircraft_id),
	CONSTRAINT fk_flight_airline FOREIGN KEY (airline_id) REFERENCES pactravel_source.airlines(airline_id),
	CONSTRAINT fk_flight_airport_dst FOREIGN KEY (airport_dst) REFERENCES pactravel_source.airports(airport_id),
	CONSTRAINT fk_flight_airport_src FOREIGN KEY (airport_src) REFERENCES pactravel_source.airports(airport_id),
	CONSTRAINT fk_flight_customer FOREIGN KEY (customer_id) REFERENCES pactravel_source.customers(customer_id)
);
...
CREATE TABLE pactravel_source.hotel_bookings (
	trip_id int4 NOT NULL,
	customer_id int4 NULL,
	hotel_id int4 NULL,
	...
	CONSTRAINT fk_hotel_booking_customer FOREIGN KEY (customer_id) REFERENCES pactravel_source.customers(customer_id),
	CONSTRAINT fk_hotel_booking_hotel FOREIGN KEY (hotel_id) REFERENCES pactravel_source.hotel(hotel_id)
);